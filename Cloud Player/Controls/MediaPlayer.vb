...
#Region "Play online video"
    ...
    Private Webbrowser As New WebControl With {.Dock = DockStyle.Fill, .BackColor = Me.BackColor, .Visible = False, .WebSession = WebCore.CreateWebSession(New WebPreferences() With {.CustomCSS = "body { background-color : rgb(27, 27, 27); }"})}
...
#Region "Play local video"
    ...
    Private WithEvents MediaPlayer As New AxWindowsMediaPlayer With {.Visible = False, .Dock = DockStyle.Fill}
